...
public class PagingBean {
	...
	public int getTotalPage(){  
		...
		if(num==0)
			...
			totalPage=totalContent/this.numberOfContentPerPage+1;  //61 content / 5 per page  +1 = 13page
		return totalPage;
	}
	/**
	 * 전체 페이지 그룹수 리턴 
	...
	public int getTotalPageGroup(){
		...
		if(num==0)
			...
			totalGroup=this.getTotalPage()/this.numberOfPageGroup+1; //13page/4그룹=4그룹!!
		return totalGroup;
	}
	/**
	...
	public int getNowPageGroup(){
		...
		if(num==0)
			...
			nowGroup=this.nowPage/this.numberOfPageGroup+1;   // 5page/ 4   +1   ==  현재 그룹 2!!!
		return nowGroup;
	}
	/**
	...
	public int getStartPageOfPageGroup(){					
		...
		int start=this.numberOfPageGroup*(this.getNowPageGroup()-1)+1;     //  4*(2-1) +1   5page
		return start;
	}
	/**
	...
	public int getEndPageOfPageGroup(){
		int end=this.numberOfPageGroup*this.getNowPageGroup();   // 4*2=  8page
	 ...
	 * @return
	 */
	public boolean isPreviousPageGroup(){      // 2 group   true
		boolean flag=false;
	...
	public boolean isNextPageGroup(){     
		boolean flag=false;
		if(this.getNowPageGroup()<this.getTotalPageGroup())    // 2그룹  < 4그룹  true
			flag=true;
		return flag;
	}
