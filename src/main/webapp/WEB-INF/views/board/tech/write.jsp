...
<form action="${pageContext.request.contextPath}/board/tech/insert?${_csrf.parameterName}=${_csrf.token}" method="post" name="write_form"
	...
	<div class="container">
		...
		<div class="container-body">
			...
			<div class="body-head">
				<div class="title">
				Title <input  name="title" placeholder="제목을 입력해주세요" class="text_title">
				</div>
				
				<div class="tag">
				Tag <input name="tag" placeholder="ex_ JAVA, WEB, ..." class="text_tag">
			...
			<div class="content">
			 ...
			 <textarea id="content" name="content"rows="10" cols="80" class="content_text"></textarea>
