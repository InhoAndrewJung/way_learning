...
<body>	
<form method=post action="${pageContext.request.contextPath}/board/tech/updateBoard" enctype="multipart/form-data">
<table cellpadding="5">
	<tr>
		<td>
			<table width="550">
				<tr>
					<td>
					<b>글번호: <input type=text name=no value=${bvo.boardNo } readonly></input>
					...
					<hr style="color:#6691BC;border-style:dotted;margin: 0">
						...
						value=${bvo.member.userId }  readonly></input>| 
						작성일시:${bvo.regDate } 
					</font>
