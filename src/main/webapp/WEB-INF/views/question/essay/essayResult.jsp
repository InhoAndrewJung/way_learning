...
<body>
	...
	<div align="center">
		<a
			href="${path}/question/essay/showEssayContent?questionNo=${questionNo}"><button
				type="button" class="btn btn-primary">서술형 문제 다시풀기</button></a> <br>
		<br> <a
			href="${pageContext.request.contextPath}/question/essay/getList">
