...
<div class="mypage_content">
	...
	<form action="${pageContext.request.contextPath}/lectureBoard/updateLecture?${_csrf.parameterName}=${_csrf.token}" method="post" name="write_form" enctype="multipart/form-data">
